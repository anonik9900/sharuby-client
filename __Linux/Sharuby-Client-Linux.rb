...
puts print "Select the Language..."
puts
puts print "English | Italian"
puts
ui_language = gets.chomp

#Italian - Windows
case ui_language
    
    when "Italian","italian","it","IT","It","Italiano","italiano"
...
case ui_language
    ...
    when "English","english","En","en","EN","eN","USA","Usa","Inglese","inglese"
